...
Specific responses regarding Reviewer \#2's comments are contained in the text that follows. We have highlighted in {\color{Orange}areas in orange} (chosen for color blindness) where we propose to further refine the manuscript in response to these comments.
