...
Rapid snow ablation in ephemeral snow regions has been shown to have a strong correlation with increases in basin streamflow in the days following snowmelt \citep{suriano2020discharge,suriano2023atmospheric}. %CMZ add cites?
...
Fig. \ref{fig:allswewy95} shows the evolution of total on-surface SWE over WY95 for all datasets. %CMZ improve figure, add panels and font size
