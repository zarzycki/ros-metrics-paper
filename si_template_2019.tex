...
\end{tabular}
\caption{As in Fig. XXX, except using the FIXED thresholds of 1.4 mm/day for ROF and dSWE instead of the RELATIVE thresholds (95th percentile of each dataset)}
